...
class Server 
{
	 ...
	 */
	public function __construct(ApiClient $apiClient, $id = null, $project_id = null, $user_id = null, $server_type_id = null, $name = null, $ip = null, $port = null, $login = null, $enabled = null, $position = null, $created_at = null, $updated_at = null)
	{
	 ...
	 */
	public function update($project_id, $server_type_id, $name, $ip, $login, $enabled, $port = null, $position = null)
	{
		...
		$bodyParameters['server_type_id'] = $server_type_id;
		...
		$response = new ServerResponse(
			...
			new Server(
				...
				$requestBody['data']['server_type_id'], 
	...
	{
		$routePath = '/api/server/{serverId}/task';
