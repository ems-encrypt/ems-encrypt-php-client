...
use EmsEncrypt\Api\Resources\ServerListResponse;
use EmsEncrypt\Api\Resources\ErrorResponse;
use EmsEncrypt\Api\Resources\ServerResponse;
use EmsEncrypt\Api\Resources\Server;
...
class ServerManager 
{
	 ...
	 * @throws UnexpectedResponseException
	 */
	public function update($serverId, $project_id, $server_type_id, $name, $ip, $login, $enabled, $port = null, $position = null)
	{
		$routePath = '/api/server/{serverId}';
