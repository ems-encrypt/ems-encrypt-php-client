...
use EmsEncrypt\Api\Resources\UserRoleListResponse;
use EmsEncrypt\Api\Resources\ErrorResponse;
use EmsEncrypt\Api\Resources\UserRoleResponse;
use EmsEncrypt\Api\Resources\UserRole;
use EmsEncrypt\Api\Resources\Meta;
use EmsEncrypt\Api\Resources\Pagination;

/**
 * UserRole manager class
 * 
...
class UserRoleManager 
{
	...
	/**
	 * UserRole manager class constructor
	 *
	...
	/**
	 * Get specified user role
	 * 
	 * Excepted HTTP code : 200
	 * 
	 * @param string $userRoleId User Role ID
	 * 
	...
	{
		$routePath = '/api/userRole/{userRoleId}';
