...
use EmsEncrypt\Api\Resources\ServerHasCertificateListResponse;
use EmsEncrypt\Api\Resources\ErrorResponse;
use EmsEncrypt\Api\Resources\ServerHasCertificateResponse;
use EmsEncrypt\Api\Resources\ServerHasCertificate;
use EmsEncrypt\Api\Resources\Meta;
use EmsEncrypt\Api\Resources\Pagination;

/**
 * ServerHasCertificate manager class
 * 
 * @package EmsEncrypt\Api\Managers
 */
class ServerHasCertificateManager 
{
	/**
	 * API client
	 *
	...
	/**
	 * ServerHasCertificate manager class constructor
	 *
	...
	/**
	 * Show server has certificate list
	 * 
	 ...
	 * @throws UnexpectedResponseException
	 */
	public function get($serverId, $domain, $projectId)
	{
